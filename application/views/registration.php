...
<div class="container mt-3">
    ...
    <form action="<?php echo base_url(); ?>registration/insertinfo" id="regForm" method="POST">
        <div class="mb-3 mt-3">
        ...
        <div class="d-grid gap-2">
            <button type="submit" id="reg_button" class="btn btn-block btn-primary">Submit</button>
